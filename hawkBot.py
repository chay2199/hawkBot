            ...
            for client_socket in clients:
                if client_socket == notified_socket:
                    ...
                    if message.decode() in greetings:
                        ...
                        client_socket.send("I did not understand what you said, "
                                           "human support initiated!".encode())
                        # Initiate human support
                        human_support()
